  ...
  try {
    ...
    for (const doc of sortedDocs) {
      try {
        ...
        console.log('📥 Downloading:', doc.name, 'Type:', doc.type);
...
- Opleidingsniveau (Kies uit: Praktijkonderwijs, VMBO, HAVO, VWO, MBO, HBO, WO)
- Rijbewijs (ja/nee)
- Vervoer beschikbaar (auto/fiets)
- Computervaardigheden (1-5: 1=Geen, 2=Basis, 3=Gemiddeld, 4=Gevorderd, 5=Expert)
- Contracturen
...
`;
    ...
    return NextResponse.json({
      ...
      message: 'Employee information successfully extracted from documents'
    });
