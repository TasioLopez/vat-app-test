...
- Sectie 17 Bijzonderheden:
  ...
  • "Algemene informatie:" — tabellen:
    ...
    • Rijbewijzen (B/C/AM, …) — apart van vervoer
    • "Hoe verplaatst werknemer zich:" — Auto | Fiets | OV | Lopend (NIET rijbewijs B)
    • computervaardigheden, talen (was apart blok in V4)
