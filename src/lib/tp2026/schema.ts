...
export const TP2026GegevensFields: TP2026FieldDef[] = [
  ...
  { key: 'is_ex_werknemer', label: 'Ex-werknemer', type: 'boolean' },
  ...
  { key: 'consultant_name', label: 'Loopbaanadviseur', type: 'text' },
  { key: 'consultant_phone', label: 'Telefoon loopbaanadviseur', type: 'text' },
  { key: 'consultant_email', label: 'E-mail loopbaanadviseur', type: 'text' },
  { key: 'current_job', label: 'Huidige functie', type: 'text' },
  { key: 'work_experience', label: 'Werkervaring', type: 'text' },
