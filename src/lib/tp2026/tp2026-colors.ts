...
export const TP2026_FIELD_TABLE_CLASS =
  'flex flex-col border-[0.5pt] border-[#c4b37b] divide-y-[0.5pt] divide-[#c4b37b]';

export const TP2026_DATA_ROW_LABEL_CLASS =
  'px-2.5 py-1.5 font-bold text-[#6d2a96] bg-[#f3efe4] border-r-[0.5pt] border-[#c4b37b] align-top';
