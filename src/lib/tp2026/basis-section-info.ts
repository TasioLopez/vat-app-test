...
De slotzin over het belastbaarheidsdocument (inclusief eventuele actualisaties) wordt automatisch toegevoegd wanneer een apart belastbaarheidsdocument aanwezig is.

Tweede alinea — vertaal afwijkende beperkingen en voorwaarden uit de leidende bron. Formuleer voorwaarden over het werk, niet over werknemer als persoon.

Verduidelijking: wanneer bronnen tegenstrijdig zijn of opleiding onduidelijk, stelt de AI een vraag. Beantwoord die in het zoekprofiel-veld via "Antwoord & opnieuw genereren" en pas daarna toe op het trajectplan.`,
  },
};
