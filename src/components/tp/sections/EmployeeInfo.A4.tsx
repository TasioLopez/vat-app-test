      ...
      <div className={paperText}>
        <Table
          rows={[
            ...
            { label: "Eigen vervoer", value: formatTransportation(null, data.transport_type) },
            { label: "Spreekvaardigheid NL-taal", value: data.dutch_speaking || "—"},
            { label: "Schrijfvaardigheid NL-taal", value: data.dutch_writing || "—"},
            { label: "Leesvaardigheid NL-taal", value: data.dutch_reading || "—" },
