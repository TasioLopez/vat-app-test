-- Run this SQL in your Supabase Dashboard SQL Editor to create the MijnStem feature
-- Go to: https://supabase.com/dashboard -> Your Project -> SQL Editor -> New Query -> Paste this -> Run

-- 1. Create the mijn_stem_documents table
...
-- 7. Create storage bucket (this will be created automatically by the app, but you can also create it manually)
-- Go to Storage in Supabase Dashboard and create a bucket named 'documents' with these settings:
-- - Name: documents
-- - Public: No (private)
